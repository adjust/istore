...
SELECT SUM_FLOOR(data, 0) FROM data;
EXPLAIN(COSTS OFF) SELECT SUM_FLOOR(data, 0) FROM data;

SELECT SUM_FLOOR(data, 2000) FROM data;
EXPLAIN(COSTS OFF) SELECT SUM_FLOOR(data, 2000) FROM data;
