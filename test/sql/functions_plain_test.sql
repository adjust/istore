...
ROLLBACK;
BEGIN;
-- bigistore functions should join to istores;
...
-- ./spec/istore/functions_plain_spec.rb:260;
CREATE EXTENSION istore;
...
-- ./spec/istore/functions_plain_spec.rb:276;
CREATE EXTENSION istore;
...
-- ./spec/istore/functions_plain_spec.rb:370;
CREATE EXTENSION istore;
SELECT sum_up('10=>5, 15=>-10'::istore);
ROLLBACK;
BEGIN;
...
ROLLBACK;
BEGIN;
-- istore functions should join to istores;
-- ./spec/istore/functions_plain_spec.rb:49;
CREATE EXTENSION istore;
