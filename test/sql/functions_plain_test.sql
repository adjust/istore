...
CREATE EXTENSION istore;
SELECT MAX(s) FROM (VALUES('-10=>5, 0=>2, 10=>3'::bigistore),('-2147483647 => 10, -10 => -9223372036854775807, 0 => 5, 10 => 9223372036854775806, 2147483647 => 10'),('-10=>1, 0=>4, 10=>5'))t(s);
ROLLBACK;
BEGIN;
-- bigistore functions should return #{type} with mined values;
-- ./spec/istore/functions_plain_spec.rb:308;
CREATE EXTENSION istore;
SELECT MIN(s) FROM (VALUES('-10=>5, 0=>2, 10=>3'::bigistore),('-2147483647 => 10, -10 => -9223372036854775807, 0 => 5, 10 => 9223372036854775806, 2147483647 => 10'),('-10=>1, 0=>4, 10=>5'))t(s);
ROLLBACK;
BEGIN;
...
-- ./spec/istore/functions_plain_spec.rb:303;
CREATE EXTENSION istore;
SELECT MAX(s) FROM (VALUES('-10=>5, 0=>2, 10=>3'::istore),('-2147483647 => 10, -10 => -2147483647, 0 => 5, 10 => 2147483647, 2147483647 => 10'),('-10=>1, 0=>4, 10=>5'))t(s);
ROLLBACK;
BEGIN;
-- istore functions should return #{type} with mined values;
-- ./spec/istore/functions_plain_spec.rb:308;
CREATE EXTENSION istore;
SELECT MIN(s) FROM (VALUES('-10=>5, 0=>2, 10=>3'::istore),('-2147483647 => 10, -10 => -2147483647, 0 => 5, 10 => 2147483647, 2147483647 => 10'),('-10=>1, 0=>4, 10=>5'))t(s);
ROLLBACK;
BEGIN;
