...
-- ./spec/istore/operator_spec.rb:16;
CREATE EXTENSION istore;
SELECT '1=>1, -1=>3'::bigistore ? -1;
...
-- ./spec/istore/operator_spec.rb:21;
CREATE EXTENSION istore;
...
-- ./spec/istore/operator_spec.rb:35;
CREATE EXTENSION istore;
SELECT '1=>1, -1=>3'::bigistore  + 1;
SELECT '-1=>1, 1=>3'::bigistore  + 1;
SELECT '-1=>1, -1=>3'::bigistore + 1;
...
-- ./spec/istore/operator_spec.rb:56;
CREATE EXTENSION istore;
SELECT '1=>1, -1=>3'::bigistore - '1=>1'::bigistore;
SELECT '1=>1, -1=>3'::bigistore - '-1=>-1'::bigistore;
SELECT '1=>1, -1=>3'::bigistore - '1=>-1'::bigistore;
...
-- ./spec/istore/operator_spec.rb:67;
CREATE EXTENSION istore;
SELECT '1=>1, -1=>3'::bigistore  - 1;
SELECT '-1=>1, 1=>3'::bigistore  - 1;
SELECT '-1=>1, -1=>3'::bigistore - 1;
...
-- ./spec/istore/operator_spec.rb:88;
CREATE EXTENSION istore;
...
-- ./spec/istore/operator_spec.rb:99;
CREATE EXTENSION istore;
SELECT '1=>1, -1=>3'::bigistore  * 1;
SELECT '-1=>1, 1=>3'::bigistore  * 1;
SELECT '-1=>1, -1=>3'::bigistore * 1;
