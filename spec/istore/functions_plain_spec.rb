...
types.each do |type|
  describe "#{type}" do
    describe 'functions' do
      ...
      it 'should join to istores' do
        query("SELECT * FROM join('0 => 1, 3 => 1, 9 => 1'::#{type}, '2 => 2, 3 => 2, 8 => 2, 10=>2'::#{type});").should match \
         ['0', '1', nil ],
         ['2', nil, '2' ],
         ['3', '1', '2' ],
         ['8', nil, '2' ],
        ...
        query("SELECT * FROM join('0 => 1, 3 => 1, 9 => 1'::#{type}, '2 => 2, 3 => 2'::#{type});").should match \
         ['0', '1', nil ],
         ['2', nil, '2' ],
         ['3', '1', '2' ],
         ['9', '1', nil ]

        query("SELECT * FROM join('2 => 1, 3 => 1'::#{type}, '2 => 2, 3 => 2'::#{type});").should match \
         ['2', '1', '2' ],
         ['3', '1', '2' ]

        query("SELECT * FROM join('2 => 1, 3 => 1'::#{type}, '2 => 2, 3 => 2'::#{type}, '2 => 3, 3 => 3'::#{type});").should match \
         ['2', '1', '2', '3' ],
         ['3', '1', '2', '3' ]
      end
