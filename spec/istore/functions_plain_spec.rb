  ...
  describe "#{type}" do
    describe 'functions' do
      ...
      it 'should join multiple istores' do
        ...
        query("SELECT * FROM join('0 => 1, 3 => 1, 9 => 1'::#{type}, '2 => 2, 3 => 2'::#{type})t(key int, a bigint, b bigint);").should match \
         ['0', '1', nil ],
         ['2', nil, '2' ],
         ['3', '1', '2' ],
         ['9', '1', nil ]

        query("SELECT * FROM join('2 => 1, 3 => 1'::#{type}, '2 => 2, 3 => 2'::#{type})t(key int, a bigint, b bigint);").should match \
         ['2', '1', '2' ],
         ['3', '1', '2' ]

        query("SELECT * FROM join('2 => 1, 3 => 1'::#{type}, '2 => 2, 3 => 2'::#{type}, '2 => 3, 3 => 3'::#{type})t(key int, a bigint, b bigint, c bigint);").should match \
         ['2', '1', '2', '3' ],
         ['3', '1', '2', '3' ]
      end
